...
<div
	class="flex h-full flex-col items-center justify-center p-6 transition-colors duration-300"
...
>
	<div class="animate-fade-in flex flex-col items-center">
		<div
			...
			"
		>
			<span class="text-4xl"><i class="fa-solid fa-image"></i></span>
		</div>
		<h2 class="mb-2 text-2xl font-bold" style="color: var(--text-main);">Screenshots</h2>
		<p class="max-w-md text-center" style="color: var(--text-sec);">
			View and manage your Minecraft screenshots. This feature is coming soon.
		</p>
	</div>
</div>
